      ...
      <div class="row">
        <div class="col-md-3 col-sm-6">
          <div class="over-view-circle wow bounceInUp  center animated" data-wow-delay=".4s">
            <span class="value counter">20</span>
            <span class="cat-name">ЛЕТ ОПЫТА</span>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="over-view-circle wow bounceInUp  center animated" data-wow-delay=".5s">
            <span class="value counter">Дофига</span>
            <span class="cat-name">УСПЕШНЫХ ПРОЕКТОВ</span>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="over-view-circle wow bounceInUp  center animated" data-wow-delay=".6s">
            <span class="value"> <span class="counter">Много</span></span>
            <span class="cat-name">СТРОК КОДА</span>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="over-view-circle wow bounceInUp  center animated" data-wow-delay=".7s">
            <span class="value counter"> ∞ </span>
            <span class="cat-name"> ИДЕЙ И ВОЗМОЖНОСТЕЙ </span>
          </div>
        </div>
      </div><!-- /.row -->
    </div><!-- /.container -->
